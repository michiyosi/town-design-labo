...
(function () {
  ...
  var Q = [
    ...
    },
    {
      ...
      src: { t: 'GUIDE 07 車検・牽引免許', u: '/trailerhouse-shaken-kenin.html' }
    },
    {
      code: 'D',
      req: 'ライフライン接続',
    ...
    },
    {
      ...
      why: {
        ...
        ng:   '車輪を取り外して基礎に固定した時点で、車両としての取扱いは失われます。この形を選ぶなら、最初から建築物として確認申請を通す計画に切り替えるほうが、結果的に手戻りがありません。'
      },
      src: { t: 'GUIDE 01 建築物か、車両か', u: '/trailerhouse-kenchikubutsu.html' }
    },
    {
    ...
    },
    {
      ...
      src: { t: 'GUIDE 04 営業許可', u: '/kitchencar-eigyo-kyoka.html' }
    }
  ];

...
(function () {
  ...
  function renderResult() {
    ...
    h += '<div class="ht-note"><strong>この判定は、安全側の目安です。</strong>8つの要件は全国共通の法定基準ではなく、国の通達に、踏み込んだ運用を公表している個別の自治体の基準を重ねて合成したものです。建築物に当たるかどうかを判断するのは、所在地を管轄する特定行政庁です。同じ仕様の車両でも、置く市町村によって結論が変わります。「他県で車両扱いだった」は根拠になりません。計画の早い段階で、管轄の特定行政庁に事前相談することを強くおすすめします。</div>';
